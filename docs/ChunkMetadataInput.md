...
json = "{}"
# create an instance of ChunkMetadataInput from a JSON string
chunk_metadata_input_instance = ChunkMetadataInput.from_json(json)
# print the JSON string representation of the object
print(ChunkMetadataInput.to_json())

# convert the object into a dict
chunk_metadata_input_dict = chunk_metadata_input_instance.to_dict()
# create an instance of ChunkMetadataInput from a dict
chunk_metadata_input_from_dict = ChunkMetadataInput.from_dict(chunk_metadata_input_dict)
```
