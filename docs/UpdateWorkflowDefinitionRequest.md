...
**selected_skill_ids** | **List[UUID]** | Skill PDO ids force-loaded into every run by default. Retain-on-None PUT semantics: null (or omit) keeps the stored list, [] clears, a list replaces. Each must be a readable SKILL. | [optional] 
