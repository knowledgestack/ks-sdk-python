...
class SkillsApi:
    ...
    def export_skills(
        self,
        export_skills_request: ExportSkillsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param export_skills_request: (required)
        :type export_skills_request: ExportSkillsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._export_skills_serialize(
            export_skills_request=export_skills_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def export_skills_with_http_info(
        self,
        export_skills_request: ExportSkillsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def export_skills_without_preload_content(
        self,
        export_skills_request: ExportSkillsRequest,
        _request_timeout: Union[
            None,
    ...
    def _export_skills_serialize(
        self,
        export_skills_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if export_skills_request is not None:
            _body_params = export_skills_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/skills/export',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
