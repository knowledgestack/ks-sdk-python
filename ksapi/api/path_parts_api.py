...
class PathPartsApi:
    ...
    @validate_call
    def reorder_path_part(
        self,
        path_part_id: UUID,
        reorder_path_part_request: ReorderPathPartRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param path_part_id: (required)
        :type path_part_id: UUID
        :param reorder_path_part_request: (required)
        :type reorder_path_part_request: ReorderPathPartRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._reorder_path_part_serialize(
            path_part_id=path_part_id,
            reorder_path_part_request=reorder_path_part_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def reorder_path_part_with_http_info(
        self,
        path_part_id: UUID,
        reorder_path_part_request: ReorderPathPartRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def reorder_path_part_without_preload_content(
        self,
        path_part_id: UUID,
        reorder_path_part_request: ReorderPathPartRequest,
        _request_timeout: Union[
    ...
    def _reorder_path_part_serialize(
        self,
        path_part_id,
        reorder_path_part_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if reorder_path_part_request is not None:
            _body_params = reorder_path_part_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/path-parts/{path_part_id}/reorder',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def transfer_path_part_owner(
        self,
        path_part_id: UUID,
        transfer_owner_request: TransferOwnerRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param path_part_id: (required)
        :type path_part_id: UUID
        :param transfer_owner_request: (required)
        :type transfer_owner_request: TransferOwnerRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._transfer_path_part_owner_serialize(
            path_part_id=path_part_id,
    ...
    @validate_call
    def transfer_path_part_owner_with_http_info(
        self,
        path_part_id: UUID,
        transfer_owner_request: TransferOwnerRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def transfer_path_part_owner_without_preload_content(
        self,
        path_part_id: UUID,
        transfer_owner_request: TransferOwnerRequest,
        _request_timeout: Union[
    ...
    def _transfer_path_part_owner_serialize(
        self,
        path_part_id,
        ...
        # process the form parameters
        # process the body parameter
        if transfer_owner_request is not None:
            _body_params = transfer_owner_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/path-parts/{path_part_id}/owner',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
