...
class WorkflowMemoryApi:
    ...
    @validate_call
    def append_workflow_memory_chunk(
        self,
        definition_id: UUID,
    ...
    @validate_call
    def append_workflow_memory_chunk_with_http_info(
        self,
        definition_id: UUID,
        append_memory_chunk_request: AppendMemoryChunkRequest,
        authorization: Optional[StrictStr] = None,
    ...
    @validate_call
    def append_workflow_memory_chunk_without_preload_content(
        self,
        definition_id: UUID,
        append_memory_chunk_request: AppendMemoryChunkRequest,
        authorization: Optional[StrictStr] = None,
    ...
    def _append_workflow_memory_chunk_serialize(
        self,
        definition_id,
        ...
        if append_memory_chunk_request is not None:
            _body_params = append_memory_chunk_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/workflow-definitions/{definition_id}/memory/chunks',
    ...
    @validate_call
    def edit_workflow_memory_chunk(
        self,
        definition_id: UUID,
        chunk_id: UUID,
        ...
        _param = self._edit_workflow_memory_chunk_serialize(
            definition_id=definition_id,
            chunk_id=chunk_id,
    ...
    @validate_call
    def edit_workflow_memory_chunk_with_http_info(
        self,
        definition_id: UUID,
        chunk_id: UUID,
        edit_memory_chunk_request: EditMemoryChunkRequest,
    ...
    @validate_call
    def edit_workflow_memory_chunk_without_preload_content(
        self,
        definition_id: UUID,
        chunk_id: UUID,
        edit_memory_chunk_request: EditMemoryChunkRequest,
    ...
    def _edit_workflow_memory_chunk_serialize(
        self,
        definition_id,
        chunk_id,
        ...
        if edit_memory_chunk_request is not None:
            _body_params = edit_memory_chunk_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/v1/workflow-definitions/{definition_id}/memory/chunks/{chunk_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def forget_workflow_memory_chunk(
        self,
        definition_id: UUID,
        chunk_id: UUID,
        authorization: Optional[StrictStr] = None,
    ...
    @validate_call
    def forget_workflow_memory_chunk_with_http_info(
        self,
        definition_id: UUID,
        chunk_id: UUID,
        authorization: Optional[StrictStr] = None,
    ...
    @validate_call
    def forget_workflow_memory_chunk_without_preload_content(
        self,
        definition_id: UUID,
        chunk_id: UUID,
        authorization: Optional[StrictStr] = None,
    ...
    def _forget_workflow_memory_chunk_serialize(
        self,
        definition_id,
        chunk_id,
        authorization,
    ...
    @validate_call
    def get_workflow_memory_chunk_with_http_info(
        self,
        definition_id: UUID,
        chunk_id: UUID,
        authorization: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_workflow_memory_chunk_without_preload_content(
        self,
        definition_id: UUID,
        chunk_id: UUID,
        authorization: Optional[StrictStr] = None,
    ...
    def _get_workflow_memory_chunk_serialize(
        self,
        definition_id,
        chunk_id,
        authorization,
    ...
    @validate_call
    def list_workflow_memory_chunks(
        self,
        definition_id: UUID,
        ...
        _param = self._list_workflow_memory_chunks_serialize(
            definition_id=definition_id,
            limit=limit,
            offset=offset,
            authorization=authorization,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResponseMemoryChunkResponse",
            '422': "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def list_workflow_memory_chunks_with_http_info(
        self,
        definition_id: UUID,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of items per page")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of items to skip")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResponseMemoryChunkResponse]:
        """List Workflow Memory Chunks Handler
    ...
    @validate_call
    def list_workflow_memory_chunks_without_preload_content(
        self,
        definition_id: UUID,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of items per page")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of items to skip")] = None,
    ...
    def _list_workflow_memory_chunks_serialize(
        self,
        definition_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/workflow-definitions/{definition_id}/memory',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
