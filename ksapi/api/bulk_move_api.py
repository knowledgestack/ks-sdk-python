...
class BulkMoveApi:
    ...
    def bulk_move(
        self,
        bulk_move_request: BulkMoveRequest,
        ...
        :param bulk_move_request: (required)
        :type bulk_move_request: BulkMoveRequest
        ...
        _param = self._bulk_move_serialize(
            bulk_move_request=bulk_move_request,
    ...
    @validate_call
    def bulk_move_without_preload_content(
        self,
        bulk_move_request: BulkMoveRequest,
        _request_timeout: Union[
            None,
    ...
    def _bulk_move_serialize(
        ...
        if bulk_move_request is not None:
            _body_params = bulk_move_request
