...
class SystemJobsApi:
    ...
    def _cancel_temporal_workflow_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/system-jobs/{workflow_id}',
    ...
    def _dv_workflow_rerun_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/system-jobs/document_versions/{workflow_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_zip_ingestion_status(
        ...
        _param = self._get_zip_ingestion_status_serialize(
            workflow_id=workflow_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ZipIngestionStatusResponse",
            '422': "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_zip_ingestion_status_with_http_info(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_zip_ingestion_status_without_preload_content(
        self,
        workflow_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_zip_ingestion_status_serialize(
        self,
        workflow_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/system-jobs/zip-ingestions/{workflow_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_dv_workflows_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/system-jobs/document_versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
