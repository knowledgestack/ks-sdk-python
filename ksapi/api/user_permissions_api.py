...
class UserPermissionsApi:
    ...
    @validate_call
    def bulk_grant_user_permissions(
        self,
        bulk_grant_request: BulkGrantRequest,
        ...
        :param bulk_grant_request: (required)
        :type bulk_grant_request: BulkGrantRequest
        ...
        _param = self._bulk_grant_user_permissions_serialize(
            bulk_grant_request=bulk_grant_request,
    ...
    @validate_call
    def bulk_grant_user_permissions_with_http_info(
        self,
        bulk_grant_request: BulkGrantRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bulk_grant_user_permissions_without_preload_content(
        self,
        bulk_grant_request: BulkGrantRequest,
        _request_timeout: Union[
            None,
    ...
    def _bulk_grant_user_permissions_serialize(
        self,
        bulk_grant_request,
        _request_auth,
        _content_type,
        ...
        if bulk_grant_request is not None:
            _body_params = bulk_grant_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/user-permissions/bulk',
    ...
    @validate_call
    def bulk_revoke_user_permissions(
        self,
        bulk_revoke_request: BulkRevokeRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param bulk_revoke_request: (required)
        :type bulk_revoke_request: BulkRevokeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._bulk_revoke_user_permissions_serialize(
            bulk_revoke_request=bulk_revoke_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def bulk_revoke_user_permissions_with_http_info(
        self,
        bulk_revoke_request: BulkRevokeRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bulk_revoke_user_permissions_without_preload_content(
        self,
        bulk_revoke_request: BulkRevokeRequest,
        _request_timeout: Union[
            None,
    ...
    def _bulk_revoke_user_permissions_serialize(
        self,
        bulk_revoke_request,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if bulk_revoke_request is not None:
            _body_params = bulk_revoke_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/user-permissions/bulk-delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
