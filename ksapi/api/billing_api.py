...
class BillingApi:
    ...
    def list_billing_payments(
        ...
        _param = self._list_billing_payments_serialize(
            tenant_id=tenant_id,
            limit=limit,
            offset=offset,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResponseBillingPaymentResponse",
    ...
    @validate_call
    def list_billing_payments_with_http_info(
        self,
        tenant_id: UUID,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of items per page")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of items to skip")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResponseBillingPaymentResponse]:
        """List Billing Payments Handler
    ...
    @validate_call
    def list_billing_payments_without_preload_content(
        self,
        tenant_id: UUID,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Number of items per page")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of items to skip")] = None,
    ...
    def _list_billing_payments_serialize(
        self,
        tenant_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tenants/{tenant_id}/billing/payments',
