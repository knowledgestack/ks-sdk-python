...
class TrashApi:
    ...
    @validate_call
    def bulk_permanently_delete_trash(
        self,
        bulk_trash_request: BulkTrashRequest,
        ...
        :param bulk_trash_request: (required)
        :type bulk_trash_request: BulkTrashRequest
        ...
        _param = self._bulk_permanently_delete_trash_serialize(
            bulk_trash_request=bulk_trash_request,
    ...
    @validate_call
    def bulk_permanently_delete_trash_with_http_info(
        self,
        bulk_trash_request: BulkTrashRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bulk_permanently_delete_trash_without_preload_content(
        self,
        bulk_trash_request: BulkTrashRequest,
        _request_timeout: Union[
            None,
    ...
    def _bulk_permanently_delete_trash_serialize(
        self,
        bulk_trash_request,
        _request_auth,
        _content_type,
        ...
        if bulk_trash_request is not None:
            _body_params = bulk_trash_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/trash/bulk-delete',
    ...
    def bulk_restore_trash(
        ...
        _param = self._bulk_restore_trash_serialize(
            bulk_trash_request=bulk_trash_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def bulk_restore_trash_with_http_info(
        self,
        bulk_trash_request: BulkTrashRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def bulk_restore_trash_without_preload_content(
        self,
        bulk_trash_request: BulkTrashRequest,
        _request_timeout: Union[
            None,
    ...
    def _bulk_restore_trash_serialize(
        self,
        bulk_trash_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/trash/bulk-restore',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_trash_item(
        ...
        _param = self._get_trash_item_serialize(
    ...
    @validate_call
    def get_trash_item_with_http_info(
        self,
        path_part_id: Annotated[UUID, Field(description="Trashed PathPart ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TrashItemDetailResponse]:
        """Get Trash Item Handler
    ...
    @validate_call
    def get_trash_item_without_preload_content(
        self,
        path_part_id: Annotated[UUID, Field(description="Trashed PathPart ID")],
        _request_timeout: Union[
            None,
