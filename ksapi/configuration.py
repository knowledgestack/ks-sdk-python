...
conf = ksapi.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ksapi")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            ...
            {
                'url': "https://{host}",
                'description': "Self-hosted deployment. Replace {host} with your Knowledge Stack host (the product is local-first / on-premise).",
                'variables': {
                    'host': {
                        'description': "No description provided",
                        'default_value': "knowledge-stack.example.com",
                        }
                    }
            },
            {
                'url': "",
                'description': "Same origin as the host serving this spec.",
            }
        ]
