...
class PaginatedResponseTenantUserResponse(BaseModel):
    """
    PaginatedResponseTenantUserResponse
    """ # noqa: E501
    items: List[TenantUserResponse] = Field(description="List of items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [TenantUserResponse.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
