...
class AncestryResponse(BaseModel):
    ...
    """ # noqa: E501
    ancestors: List[PathPartAncestorItem] = Field(description="Ancestors ordered root-to-leaf")
    __properties: ClassVar[List[str]] = ["ancestors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ancestors": [PathPartAncestorItem.from_dict(_item) for _item in obj["ancestors"]] if obj.get("ancestors") is not None else None
        })
        return _obj
