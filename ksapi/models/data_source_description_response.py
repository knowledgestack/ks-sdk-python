...
class DataSourceDescriptionResponse(BaseModel):
    """
    Result of (re)generating a connector's searchable description Document.
    """ # noqa: E501
    data_source_id: UUID
    description_document_id: UUID = Field(description="PDO id of the generated, ingested 'Database overview' doc")
    __properties: ClassVar[List[str]] = ["data_source_id", "description_document_id"]
