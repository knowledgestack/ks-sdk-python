...
class TestConnectionRequest(BaseModel):
    ...
    """ # noqa: E501
    data_source_id: Optional[UUID] = Field(default=None, description="Test a stored connector instead of fresh creds")
    engine: Optional[DataSourceEngine] = None
    connection_config: Optional[ConnectionConfig] = None
    parent_path_part_id: Optional[UUID] = Field(default=None, description="Fresh-creds mode: the folder the connector would be created under; the probe is gated by write access to it.")
    __properties: ClassVar[List[str]] = ["data_source_id", "engine", "connection_config", "parent_path_part_id"]
