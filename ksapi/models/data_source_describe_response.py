...
class DataSourceDescribeResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    data_source_id: UUID
    tables_total: StrictInt = Field(description="Modeled tables considered")
    summarized: StrictInt = Field(description="Tables whose summary was (re)generated")
    embedded: StrictInt = Field(description="Tables whose Qdrant point was (re)written")
    __properties: ClassVar[List[str]] = ["data_source_id", "tables_total", "summarized", "embedded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tables_total": obj.get("tables_total"),
