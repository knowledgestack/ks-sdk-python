...
class ExportSkillsRequest(BaseModel):
    ...
    """ # noqa: E501
    skill_ids: Annotated[List[UUID], Field(min_length=1, max_length=50)] = Field(description="Skills whose frozen active versions are packed together; duplicates are ignored. Every skill must exist and be readable.")
    __properties: ClassVar[List[str]] = ["skill_ids"]
