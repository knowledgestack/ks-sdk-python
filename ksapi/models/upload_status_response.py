...
class UploadStatusResponse(BaseModel):
    ...
    uploaded_bytes: StrictInt
    __properties: ClassVar[List[str]] = ["parts", "uploaded_bytes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parts": [UploadPartResponse.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None,
