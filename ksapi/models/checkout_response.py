...
class CheckoutResponse(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="Stripe Checkout URL (action=REDIRECT).")
    credential: Optional[Dict[str, Any]] = Field(default=None, description="Ping++ charge credential (action=CREDENTIAL).")
    __properties: ClassVar[List[str]] = ["action", "billing_system", "url", "credential"]
