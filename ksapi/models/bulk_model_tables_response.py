...
class BulkModelTablesResponse(BaseModel):
    """
    Per-item results of a bulk import; one entry per requested table.
    """ # noqa: E501
    results: List[ModelTableResult]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ModelTableResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
