...
class PaginatedResponseAnnotatedUnionSectionContentItemChunkContentItemDiscriminator(BaseModel):
    """
    PaginatedResponseAnnotatedUnionSectionContentItemChunkContentItemDiscriminator
    """ # noqa: E501
    items: List[SectionContentItemOrChunkContentItem] = Field(description="List of items")
