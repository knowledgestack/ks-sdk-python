...
class ExcludedCommonFile(BaseModel):
    """
    ...
    """ # noqa: E501
    path_part_id: UUID = Field(description="The common file's path_part id, as set on the definition")
    reason: CommonFileExclusionReason
    __properties: ClassVar[List[str]] = ["path_part_id", "reason"]
