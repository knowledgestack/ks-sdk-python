...
class UpdateWorkflowDefinitionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "runner_type", "runner_config", "max_run_duration_seconds", "source_path_part_ids", "instruction_path_part_ids", "output_path_part_ids", "template_path_part_id", "is_active"]
