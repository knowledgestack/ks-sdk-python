...
class BulkGrantRequest(BaseModel):
    ...
    """ # noqa: E501
    tenant_id: UUID
    grants: Optional[List[BulkGrantItem]] = None
    __properties: ClassVar[List[str]] = ["tenant_id", "grants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grants": [BulkGrantItem.from_dict(_item) for _item in obj["grants"]] if obj.get("grants") is not None else None
        })
        return _obj
