...
class InvokeWorkflowRequest(BaseModel):
    ...
    """ # noqa: E501
    idempotency_key: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Optional key to prevent duplicate runs from retries")
    __properties: ClassVar[List[str]] = ["idempotency_key"]
