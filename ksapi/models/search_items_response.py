...
class SearchItemsResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[FolderResponseOrDocumentResponseOrWorkflowDefinitionResponseOrWorkflowRunResponseOrDataSourceResponseOrDataSourceSchemaR] = Field(description="List of items")
    ...
    counts_by_type: Optional[Dict[str, StrictInt]] = Field(default=None, description="Matches per item type, keyed by SearchablePartType and unaffected by the part_type filter")
    __properties: ClassVar[List[str]] = ["items", "total", "limit", "offset", "counts_by_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [FolderResponseOrDocumentResponseOrWorkflowDefinitionResponseOrWorkflowRunResponseOrDataSourceResponseOrDataSourceSchemaR.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
            "offset": obj.get("offset"),
            "counts_by_type": obj.get("counts_by_type")
        })
        return _obj
