...
class ModelTableResult(BaseModel):
    """
    ...
    status: StrictStr
    table: Optional[DataSourceTableResponse] = None
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["table_name", "schema_name", "status", "table", "error"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['created', 'conflict', 'error']):
            raise ValueError("must be one of enum values ('created', 'conflict', 'error')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "table": DataSourceTableResponse.from_dict(obj["table"]) if obj.get("table") is not None else None,
            "error": obj.get("error")
        })
        return _obj
