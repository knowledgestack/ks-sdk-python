...
class RunFolder(BaseModel):
    ...
    assets: Optional[List[WorkflowRunAsset]] = None
    __properties: ClassVar[List[str]] = ["id", "path_part_id", "materialized_path", "assets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assets": [WorkflowRunAsset.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None
        })
        return _obj
