...
class IngestZipResponse(BaseModel):
    ...
    total_found: StrictInt
    succeeded: StrictInt
    skipped: StrictInt
    failed: StrictInt
    __properties: ClassVar[List[str]] = ["files", "total_found", "succeeded", "skipped", "failed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "files": [ZipFileResult.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None,
