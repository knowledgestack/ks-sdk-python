...
class SubtreeChunksResponse(BaseModel):
    """
    Response for subtree resolution.
    """ # noqa: E501
    groups: List[SubtreeChunkGroup]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [SubtreeChunkGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
