...
class BulkGrantResponse(BaseModel):
    ...
    """ # noqa: E501
    succeeded: Optional[List[BulkGrantSuccess]] = None
    failed: Optional[List[BulkGrantItemFailure]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "succeeded": [BulkGrantSuccess.from_dict(_item) for _item in obj["succeeded"]] if obj.get("succeeded") is not None else None,
            "failed": [BulkGrantItemFailure.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
