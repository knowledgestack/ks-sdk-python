...
class ToolPart(BaseModel):
    ...
    display_type: Optional[ToolDisplayType] = None
    __properties: ClassVar[List[str]] = ["id", "seq", "start_time", "end_time", "kind", "tool_call_id", "tool_name", "input", "status", "result", "is_error", "duration_ms", "extras", "display_type"]
