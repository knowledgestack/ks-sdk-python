...
class UpdateWorkflowRunRequest(BaseModel):
    ...
    """ # noqa: E501
    input_scope: Optional[Annotated[List[UUID], Field(max_length=200)]] = Field(default=None, description="New KB-reference scope (DOCUMENT + FOLDER + DATA_SOURCE + API_CONNECTION pp_ids). Replaces the row's ``input_path_part_ids`` wholesale. Uploaded files live in ``inputs/`` and are walked at Start; they are not part of this list.")
