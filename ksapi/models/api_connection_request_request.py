...
class ApiConnectionRequestRequest(BaseModel):
    """
    An outbound request the caller (or agent) wants executed.
    """ # noqa: E501
    method: Annotated[str, Field(strict=True, max_length=16)]
    path: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = '/'
    query: Optional[Dict[str, StrictStr]] = None
    headers: Optional[Dict[str, StrictStr]] = None
    body: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["method", "path", "query", "headers", "body"]
