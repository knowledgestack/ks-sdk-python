...
class DiagnosticsResponse(BaseModel):
    ...
    DiagnosticsResponse
    """ # noqa: E501
    final: StrictBool = Field(description="True when no item is pending.")
    traces: List[DiagnosticTraceItem]
    __properties: ClassVar[List[str]] = ["final", "traces"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "final": obj.get("final"),
            "traces": [DiagnosticTraceItem.from_dict(_item) for _item in obj["traces"]] if obj.get("traces") is not None else None
        })
        return _obj
