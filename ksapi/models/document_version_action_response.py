...
class DocumentVersionActionResponse(BaseModel):
    """
    Response from a document version action.
    """ # noqa: E501
    version_id: UUID = Field(description="DocumentVersion ID")
    action: DocumentVersionAction
    workflow_id: StrictStr = Field(description="Temporal workflow ID")
    __properties: ClassVar[List[str]] = ["version_id", "action", "workflow_id"]
