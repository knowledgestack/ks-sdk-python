...
class ProposedMemoryChunkResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["chunk_id", "scope", "owner_path_part_id", "kind", "rationale", "body", "proposer_tenant_user_id", "run_id"]
