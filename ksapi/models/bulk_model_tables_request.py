...
class BulkModelTablesRequest(BaseModel):
    """
    Import several tables (across one or more schemas) in one call.
    """ # noqa: E501
    tables: Annotated[List[ModelTableRequest], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tables": [ModelTableRequest.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None
        })
        return _obj
