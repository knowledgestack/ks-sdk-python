...
class BulkOperationResponse(BaseModel):
    ...
    """ # noqa: E501
    succeeded: Optional[List[UUID]] = None
    failed: Optional[List[BulkItemFailure]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failed": [BulkItemFailure.from_dict(_item) for _item in obj["failed"]] if obj.get("failed") is not None else None
        })
        return _obj
