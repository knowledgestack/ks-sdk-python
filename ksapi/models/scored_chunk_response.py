...
class ScoredChunkResponse(BaseModel):
    ...
    score: Union[StrictFloat, StrictInt] = Field(description="Cosine similarity score (1 - cosine_distance)")
    __properties: ClassVar[List[str]] = ["id", "path_part_id", "content_id", "content", "chunk_type", "chunk_metadata", "num_tokens", "parent_path_id", "prev_sibling_path_id", "next_sibling_path_id", "materialized_path", "system_managed", "tenant_id", "created_at", "updated_at", "asset_s3_urls", "document", "document_version", "score"]
