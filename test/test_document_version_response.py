...
class TestDocumentVersionResponse(unittest.TestCase):
    """DocumentVersionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentVersionResponse:
        """Test DocumentVersionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentVersionResponse`
        """
        model = DocumentVersionResponse()
        if include_optional:
    ...
    def testDocumentVersionResponse(self):
        """Test DocumentVersionResponse"""
